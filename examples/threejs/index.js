...
function init() {
    ...
    const dracoLoader = new DRACOLoader().setDecoderPath( '../../libs/three.js/r150/examples/jsm/libs/draco/gltf/' );
    loader.setDRACOLoader( dracoLoader );

    const ktx2Loader = new KTX2Loader().setTranscoderPath( '../../libs/three.js/r150/examples/jsm/libs/basis/' );
